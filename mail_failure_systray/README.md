...
## Source audit / migration notes (Odoo 18)
...
This package is the Odoo 18 migration of the original Odoo 19 module.
Key compatibility changes include the Odoo 18 ORM `_search` signature/domain handling,
legacy `_sql_constraints` declaration, and the Odoo 18 `mail.mail._postprocess_sent_message`
method signature. The functional behavior remains the same.
